        ...
        <div id="rs-slider" class="slider-overlay-2">     
        	<div id="home-slider">
				...
				<div class="item active">
					<img src="student/images/slider/home1/batbio_1.jpg" style="height: 486px;" alt="Slide1" />
				...
				<!-- Item 2 -->
				<div class="item">
					<img src="student/images/slider/home1/batbio2.jpg" style="height: 486px;" alt="Slide2" />
					<div class="slide-content">
						<div class="display-table">
							<div class="display-table-cell">
								<div class="container text-center">
				...
				<!-- Item 3 -->
				<div class="item">
					<img src="student/images/slider/home1/batbio3.jpg" style="height: 486px;" alt="Slide3" />
					<div class="slide-content">
						<div class="display-table">
							<div class="display-table-cell">
								<div class="container text-center">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-img rs-animation-hover">
							<img src="student/images/about/about.jpg" alt="img02"/>
						...
						<div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="false" data-autoplay-timeout="5000" data-smart-speed="1200" data-dots="true" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="true" data-ipad-device="2" data-ipad-device-nav="true" data-ipad-device-dots="true" data-md-device="3" data-md-device-nav="true" data-md-device-dots="true">
			                <div class="cource-item">
			                    <div class="cource-img">
			                        <img src="student/images/courses/1.jpg" alt="" />
			                ...
			                <div class="cource-item">
			                    <div class="cource-img">
			                        <img src="student/images/courses/2.jpg" alt="" />
                                    <a class="image-link" href="courses-details.html" title="University Tour 2018">
                                        <i class="fa fa-link"></i>
                                    </a>
			                ...
			                <div class="cource-item">
			                    <div class="cource-img">
			                        <img src="student/images/courses/3.jpg" alt="" />
                                    <a class="image-link" href="courses-details.html" title="University Tour 2018">
                                        <i class="fa fa-link"></i>
                                    </a>
        ...
        <div id="rs-team" class="rs-team sec-color sec-spacer">
            <div class="container">
				...
				<div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="false" data-autoplay-timeout="5000" data-smart-speed="1200" data-dots="true" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="true" data-ipad-device="2" data-ipad-device-nav="true" data-ipad-device-dots="true" data-md-device="3" data-md-device-nav="true" data-md-device-dots="true">
                    ...
                    <div class="team-item">
                        <div class="team-img">
                            <img src="student/images/team/2.jpg" alt="team Image" />
							<div class="normal-text">
                    ...
                    <div class="team-item">
                        <div class="team-img">
                            <img src="student/images/team/3.jpg" alt="team Image" />
							<div class="normal-text">
...
-->
            ...
            <div class="container">
				<div class="rs-carousel owl-carousel" data-loop="true" data-items="5" data-margin="80" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="2" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="4" data-ipad-device-nav="false" data-ipad-device-dots="false" data-md-device="5" data-md-device-nav="false" data-md-device-dots="false">
                    <div class="partner-item">
                        <a href="#"><img src="student/images/partner/1.png" alt="Partner Image"></a>
                    </div>
                    <div class="partner-item">
                        <a href="#"><img src="student/images/partner/2.png" alt="Partner Image"></a>
                    </div>
                    <div class="partner-item">
                        <a href="#"><img src="student/images/partner/3.png" alt="Partner Image"></a>
                    </div>
                    <div class="partner-item">
                        <a href="#"><img src="student/images/partner/4.png" alt="Partner Image"></a>
                    </div>
                    <div class="partner-item">
                        <a href="#"><img src="student/images/partner/5.png" alt="Partner Image"></a>
                    </div>
        ...
        <footer id="rs-footer" class="bg3 rs-footer">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="copyright">
                        <p>© 2021 <a href="#">SOFTMRI</a>. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
        ...
        <nav class="right_menu_togle">
            ...
            <div class="canvas-logo">
                <a href="index.html"><img src="student/images/logo-white.png" alt="logo"></a>
            </div>
        ...
        <!-- modernizr js -->
        <script src="student/js/modernizr-2.8.3.min.js"></script>
		...
		<!-- slick.min js -->
        <script src="student/js/slick.min.js"></script>
        <!-- isotope.pkgd.min js -->
        <script src="student/js/isotope.pkgd.min.js"></script>
        <!-- student/imagesloaded.pkgd.min js -->
        <script src="student/js/imagesloaded.pkgd.min.js"></script>
        <!-- wow js -->
        <script src="student/js/wow.min.js"></script>
        <!-- counter top js -->
        <script src="student/js/waypoints.min.js"></script>
        <script src="student/js/jquery.counterup.min.js"></script>
        <!-- magnific popup -->
        <script src="student/js/jquery.magnific-popup.min.js"></script>
        <!-- rsmenu js -->
        <script src="student/js/rsmenu-main.js"></script>
        <!-- plugins js -->
        <script src="student/js/plugins.js"></script>
		 <!-- main js -->
