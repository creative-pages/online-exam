                        ...
                        <div class="col-12">
                            <form class="form-horizontal mt-3 form-material" id="loginform" action="" method="post">
                                <div class="form-group mb-3">
                                    <div class="">
                                        <input class="form-control" type="text" required="" placeholder="Enter Your Id" name = "id"> </div>
                                </div>
                                ...
                                <div class="form-group mb-0 mt-4">
                                    <div class="col-sm-12 justify-content-center d-flex">
                                        <p>Don't have an account? <a href="student-register.php" class="text-info font-weight-medium ms-1">Sign Up</a></p>
                                    </div>
                                </div>
                            </form>
                        </div>
