                        ...
                        <div class="table-responsive">
                            <table class="table search-table v-middle">
                                ...
                                <tbody>
                                    <!-- row -->
                                    <?php
                                        $sub = $common->select("`subject_add` ORDER BY `batch_id`+0 DESC");
                                        if($sub){
                                            while($raw = mysqli_fetch_assoc($sub)){
                                                $batch = $raw['batch_id'];
                                                $b_name = $common->select("`add_branch`","`id`='$batch'");
                                                $batchname = mysqli_fetch_assoc($b_name);
                                    ...
                                    <tr class="search-items">
                                        ...
                                        <td>
                                            <span class="usr-email-addr" ><?= $batchname['branch_name'];?></span>
                                        </td>
                                        <td>
                                            <span class="usr-email-addr"><?= $raw['subject_name']?></span>
                                        </td>
                                        
                                        <td>
                                            <div class="action-btn">
                                                <a href="edit-subject.php?editsub=<?= $raw['id']?>" class="text-info edit"><i data-feather="eye" class="feather-sm fill-white"></i></a>
                                                <a onclick="return confirm('Are you sure you want to Delete')" href="?dltsub=<?= $raw['id']?>" class="text-infodark delete ms-2"><i data-feather="trash-2" class="feather-sm fill-white"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php }}?>
