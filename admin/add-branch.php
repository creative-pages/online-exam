                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-3 contact-location">
                                                            <input type="text" id="c-location" class="form-control" placeholder="Enter Branch Name"name= "branchname">
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <table class="table search-table v-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr class="search-items">
                                        ...
                                        <td>
                                            <span class="usr-ph-no"><?=$value['branch_name'];?></span>
                                        </td>
                                        <td>
                                            <div class="action-btn">
                                                <a href="javascript:void(0)" class="text-info edit"><i data-feather="eye" class="feather-sm fill-white"></i></a>
                                                <a onclick="return confirm('Are you want to sure to delete?')" href="?dltbranch=<?=$value['id'];?>" class="text-dark delete ms-2"><i data-feather="trash-2" class="feather-sm fill-white"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php }} ?>
