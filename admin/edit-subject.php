...
<?php
    if(isset($_GET['editsub'])){
        $id = $_GET['editsub'];
        $allsub = $common->select("`subject_add`","`id`='$id'");
        $allsubject = mysqli_fetch_assoc($allsub);
    }
...
<?php
    if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['update'])){
        ...
        $batch = $_POST['batch'];
        $success = $common->update("`subject_add`","`batch_id` = '$batch',`subject_name` = '$subject_name'","`id`='$id'");
        if($success){
                        ...
                        <form class="form-horizontal" action="" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="com1" value="<?=$allsubject['subject_name'];?>" name = "subject_name">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select" name = "batch" id = "batch">
                                            ...
                                            ?>
                                            <option <?php if($allsubject['batch_id']==$raw['id']){?> selected="selected"<?php } ?> value = <?=$raw['id'];?>><?=$raw['branch_name']; ?></option>
                                            <?php }}?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="p-3 border-top">
                                <div class="text-end">
                                    <button type="submit" class="btn btn-info rounded-pill px-4 waves-effect waves-light" name = "update">Save</button>
