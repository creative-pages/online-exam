...
<section class="px-5 w-full"><h1 class="text-3xl font-medium text-gray-700 text-center my-2">Select your batch</h1>
    ...
    <?php }}?>
    <a class="flex items-center justify-center font-semibold text-primary-500 rounded-lg border-2 text-lg h-14 w-60 border-primary transition duration-300 ease-in-out hover:bg-primary-500 hover:text-primary-50" href="/exams/warriors">Warriors
	</a><a class="flex items-center justify-center font-semibold text-primary-500 rounded-lg border-2 text-lg h-14 w-60 border-primary transition duration-300 ease-in-out hover:bg-primary-500 hover:text-primary-50" href="/exams/prottasa">প্রত্যাশা  
	</a><a class="flex items-center justify-center font-semibold text-primary-500 rounded-lg border-2 text-lg h-14 w-60 border-primary transition duration-300 ease-in-out hover:bg-primary-500 hover:text-primary-50" href="/exams/gke-crash-course">GKE Crash Course 
	</a><a class="flex items-center justify-center font-semibold text-primary-500 rounded-lg border-2 text-lg h-14 w-60 border-primary transition duration-300 ease-in-out hover:bg-primary-500 hover:text-primary-50" href="/exams/and">অনুশীলনী &amp; বিগত বছরের  প্রশ্ন 
	</a></div></section></div>
